...
class Exp_Informer(Exp_Basic):
    ...
    def predict(self, setting, load=False):
        ...
        self.save_txt(folder_path + 'real_prediction.txt', preds)
        real_preds_orig = pred_data.inverse_transform_tar(torch.from_numpy(preds))
        real_preds_orig_np = real_preds_orig.numpy()
        self.save_txt(folder_path + 'real_pred_orig.txt', real_preds_orig_np)
        return
